...
import pickle, time, errno
import io, zipfile, tempfile
import traceback

from sim21.old.thermo.Hypo import *
from sim21.old.thermo.ThermoAdmin import ThermoAdmin, ThermoCase, PureCompoundProperty, EnvelopeResults
from sim21.old.unitop import UnitOperations, Envelope
from sim21.old.unitop.UnitOperations import TH_ADMIN_KEYWORD
from sim21.old.solver import Flowsheet
from sim21.old.solver.Error import CallBackException
...
class CommandInterface(object):
    ...
    def __init__(self, baseFlowsheet=None, infoCallBack=None):
        ...
        self.createableModules = ['sim21.old.unitop', 'sim21.old.thermo', 'sim21.old.solver', 'sim21.old.design']
    ...
    def CreateObject(self, parent, name, opTypeDesc):
        ...
        modules = [i for i in list(sys.modules.keys()) if i.startswith('sim21')]
        m = None
        import importlib
