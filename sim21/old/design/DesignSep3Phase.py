...
import math
from sim21.old.design.Design import BasicDesignParameter, DesignMain
from sim21.old.design.Design import STR_INFO, FLT_INFO, BOOL_INFO, OPT_INFO
from sim21.old.design.Design import PORT_INFO, INLET_INFO, OUTLET_INFO, USESUNIT_INFO
from sim21.old.design.DesignTools import HNATable, GTable, FinalValue, VesselWeightAndWallThickness, Kvalue
...
class Separator3Phase(DesignMain):
    def __init__(self):
        ...
        self._input['HoldupTime'] = BasicDesignParameter(self, 'HoldupTime', INLET_INFO | FLT_INFO | USESUNIT_INFO,
                                                         TIME_VAR, idx=18)
        self._input['SurgeTime'] = BasicDesignParameter(self, 'SurgeTime', INLET_INFO | FLT_INFO | USESUNIT_INFO,
                                                        TIME_VAR, idx=20)
        self._input['Mist'] = BasicDesignParameter(self, 'MistEliminator', INLET_INFO | BOOL_INFO, idx=22)
        self._input['Liq-LiqSepType'] = BasicDesignParameter(self, 'Liq-LiqSepType', INLET_INFO | STR_INFO | OPT_INFO,
                                                             None, ['HC-Water', 'HC-Caustic', 'Other'], idx=24)
        self._input['ServiceType'] = BasicDesignParameter(self, 'ServiceType', INLET_INFO | STR_INFO | OPT_INFO, None,
                                                          ['Refinery', 'PetChem', 'Other'], idx=26)
        ...
        self._output['VapDisengagementHeight'] = BasicDesignParameter(self, 'VapDisengagementHeight', genOutputType,
                                                                      LENGTH_VAR, idx=6)
        ...
        self._output['VesselWallThickness'] = BasicDesignParameter(self, 'WallThickness', genOutputType, LENGTH_VAR,
                                                                   idx=14)
...
class Vertical(Separator3Phase):
    ...
    def Solve(self):
        ...
        rhoLiq = (Wll / (Wll + Whl)) * rhol + (
            Whl / (Wll + Whl)) * rhoh  # use mix liquid density of light and heavy liquids
...
class HorizontalWithBoot(Separator3Phase):
    ...
    def __init__(self):
        ...
        self._output['BootDiameter'] = BasicDesignParameter(self, 'BootDiameter',
                                                            OUTLET_INFO | FLT_INFO | USESUNIT_INFO, LENGTH_VAR, idx=40)
        self._output['BootHeight'] = BasicDesignParameter(self, 'BootHeight', OUTLET_INFO | FLT_INFO | USESUNIT_INFO,
                                                          LENGTH_VAR, idx=42)
...
class HorizontalWithWeir(Separator3Phase):
    ...
    def __init__(self):
        ...
        self._output['WeirHeight'] = BasicDesignParameter(self, 'WeirHeight', OUTLET_INFO | FLT_INFO | USESUNIT_INFO,
                                                          LENGTH_VAR, idx=50)
        self._output['LengthToWeir'] = BasicDesignParameter(self, 'LengthToWeir',
                                                            OUTLET_INFO | FLT_INFO | USESUNIT_INFO, LENGTH_VAR, idx=52)
...
class HorizontalWithWeirAndBucket(Separator3Phase):
    ...
    def __init__(self):
        ...
        self._output['LengthToLLiqWeir'] = BasicDesignParameter(self, 'LengthToLLiqWeir', genOutputType, LENGTH_VAR,
                                                                idx=64)
        self._output['LengthBetweenWeirs'] = BasicDesignParameter(self, 'LengthBetweenWeirs', genOutputType, LENGTH_VAR,
                                                                  idx=66)
        self._output['LLiqBucketLength'] = BasicDesignParameter(self, 'LLiqBucketLength', genOutputType, LENGTH_VAR,
                                                                idx=68)
        self._output['HLiqBucketLength'] = BasicDesignParameter(self, 'HLiqBucketLength', genOutputType, LENGTH_VAR,
                                                                idx=70)
