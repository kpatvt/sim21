...
# Common constants
from sim21.old.unitop.BaseForReactors import QEXOTHERMIC_ISPOS_PAR, NURXN_PAR, REACTION
from sim21.old.solver.Messages import MessageHandler
from sim21.old.solver.Variables import *
from sim21.old.unitop import UnitOperations, Balance, Sensor, Stream
from sim21.old.unitop.ConvRxn import ConversionReaction
from sim21.old.unitop.Pump import ATable
...
class InternalEqmReactor(UnitOperations.UnitOperation):
    ...
    def PropagatePressure(self):
        ...
        if outP is None:
            if dP is not None and inP is not None:
