...
from sim21.old.solver.Ports import *
...
class Set(UnitOperations.UnitOperation):
    ...
    def Solve(self):
        ...
        if a is None:
            if v0 and v1 is not None and b is not None:
        ...
        if otherPort is None:
            ...
            if myType != SIGNAL_TYPE_NONE and otherType != SIGNAL_TYPE_NONE and myType != otherType:
                ...
                if setSig:
                    ...
                    if not self.addPort.IsPortConnected() and addPortValue is not None:
