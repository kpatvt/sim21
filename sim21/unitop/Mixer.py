...
from sim21.unitop.UnitOperations import OpParameter
...
class Mixer(UnitOperations.UnitOperation):
    ...
    def Solve(self):
        ...
        if solveP == LOWESTP_METHOD:
            ...
            inPorts = list(self.ports_mat_IN.values())
            for port in inPorts:
            ...
            elif outP is not None and nuNones == 1:
                if minP is None or outP <= minP:  # What to do if not? Raise an error?
